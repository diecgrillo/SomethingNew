...
describe('MyCategoriesPage', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      imports: [
        IonicModule.forRoot(MyCategoriesPage),
        HttpModule
      ],
      providers: [
        {
  ...
  it('should load the categories array, render only the categories the user is subscribed, and present these categories with at most 4 videos each', (done) => {
      ...
      fixture.whenStable().then(() => {
        ...
        fixture.whenStable().then(() => {
          ...
          for(let i=0;i<comp.categories.length;i++){
            ...
            // Test if the elements are visible
            let cardCategoryElement = de[i].nativeElement;
            expect(((cardCategoryElement.getAttribute("hidden") == null) && (category.assigned == true))
              ||((cardCategoryElement.getAttribute("hidden") != null) && (category.assigned == false)))
